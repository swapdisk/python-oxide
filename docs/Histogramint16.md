...
------------ | ------------- | ------------- | -------------
**bins** | [**List[Binint16]**](Binint16.md) | The bins of the histogram. | 
...
json = "{}"
# create an instance of Histogramint16 from a JSON string
histogramint16_instance = Histogramint16.from_json(json)
# print the JSON string representation of the object
print(Histogramint16.to_json())

# convert the object into a dict
histogramint16_dict = histogramint16_instance.to_dict()
# create an instance of Histogramint16 from a dict
histogramint16_from_dict = Histogramint16.from_dict(histogramint16_dict)
```
