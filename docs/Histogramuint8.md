...
------------ | ------------- | ------------- | -------------
**bins** | [**List[Binuint8]**](Binuint8.md) | The bins of the histogram. | 
...
json = "{}"
# create an instance of Histogramuint8 from a JSON string
histogramuint8_instance = Histogramuint8.from_json(json)
# print the JSON string representation of the object
print(Histogramuint8.to_json())

# convert the object into a dict
histogramuint8_dict = histogramuint8_instance.to_dict()
# create an instance of Histogramuint8 from a dict
histogramuint8_from_dict = Histogramuint8.from_dict(histogramuint8_dict)
```
