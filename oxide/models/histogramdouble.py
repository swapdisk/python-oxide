...
class Histogramdouble(BaseModel):
    ...
    """ # noqa: E501
    bins: List[Bindouble] = Field(description="The bins of the histogram.")
    max: Union[StrictFloat, StrictInt] = Field(description="The maximum value of all samples in the histogram.")
    min: Union[StrictFloat, StrictInt] = Field(description="The minimum value of all samples in the histogram.")
    ...
    sum_of_samples: Union[StrictFloat, StrictInt] = Field(description="The sum of all samples in the histogram.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bins": [Bindouble.from_dict(_item) for _item in obj["bins"]] if obj.get("bins") is not None else None,
            "max": obj.get("max"),
            "min": obj.get("min"),
