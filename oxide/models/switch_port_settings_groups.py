...
class SwitchPortSettingsGroups(BaseModel):
    ...
    """ # noqa: E501
    port_settings_group_id: StrictStr = Field(description="The id of a port settings group being referenced by a port settings object.")
    port_settings_id: StrictStr = Field(description="The id of a port settings object referencing a port settings group.")
    __properties: ClassVar[List[str]] = ["port_settings_group_id", "port_settings_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "port_settings_group_id": obj.get("port_settings_group_id"),
