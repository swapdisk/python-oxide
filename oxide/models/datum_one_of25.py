...
class DatumOneOf25(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['histogram_f32']):
            raise ValueError("must be one of enum values ('histogram_f32')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datum": Histogramfloat.from_dict(obj["datum"]) if obj.get("datum") is not None else None,
            "type": obj.get("type")
        })
        return _obj
