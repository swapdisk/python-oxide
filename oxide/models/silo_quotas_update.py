...
class SiloQuotasUpdate(BaseModel):
    ...
    """ # noqa: E501
    cpus: Optional[StrictInt] = Field(default=None, description="The amount of virtual CPUs available for running instances in the Silo")
    memory: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The amount of RAM (in bytes) available for running instances in the Silo")
    storage: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The amount of storage (in bytes) available for disks or snapshots")
    __properties: ClassVar[List[str]] = ["cpus", "memory", "storage"]
