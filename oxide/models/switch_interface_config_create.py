...
class SwitchInterfaceConfigCreate(BaseModel):
    ...
    """ # noqa: E501
    kind: SwitchInterfaceKind = Field(description="What kind of switch interface this configuration represents.")
    v6_enabled: StrictBool = Field(description="Whether or not IPv6 is enabled.")
    __properties: ClassVar[List[str]] = ["kind", "v6_enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": SwitchInterfaceKind.from_dict(obj["kind"]) if obj.get("kind") is not None else None,
