...
class InstanceNetworkInterfaceAttachmentOneOf(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "params": [InstanceNetworkInterfaceCreate.from_dict(_item) for _item in obj["params"]] if obj.get("params") is not None else None,
            "type": obj.get("type")
        })
        return _obj
