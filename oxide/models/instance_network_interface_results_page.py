...
class InstanceNetworkInterfaceResultsPage(BaseModel):
    ...
    """ # noqa: E501
    items: List[InstanceNetworkInterface] = Field(description="list of items on this page of results")
    next_page: Optional[StrictStr] = Field(default=None, description="token used to fetch the next page of results (if any)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [InstanceNetworkInterface.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
