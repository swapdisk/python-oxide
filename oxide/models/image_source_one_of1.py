...
class ImageSourceOneOf1(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['you_can_boot_anything_as_long_as_its_alpine']):
            raise ValueError("must be one of enum values ('you_can_boot_anything_as_long_as_its_alpine')")
        return value
