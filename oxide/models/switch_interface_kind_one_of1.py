...
class SwitchInterfaceKindOneOf1(BaseModel):
    """
    ...
    """ # noqa: E501
    type: StrictStr
    vid: Annotated[int, Field(strict=True, ge=0)] = Field(description="The virtual network id (VID) that distinguishes this interface and is used for producing and consuming 802.1Q Ethernet tags. This field has a maximum value of 4095 as 802.1Q tags are twelve bits.")
    __properties: ClassVar[List[str]] = ["type", "vid"]
