...
class SwitchBgpHistory(BaseModel):
    ...
    """ # noqa: E501
    history: Dict[str, Any] = Field(description="Message history indexed by peer address.")
    switch: SwitchLocation = Field(description="Switch this message history is associated with.")
    __properties: ClassVar[List[str]] = ["history", "switch"]
