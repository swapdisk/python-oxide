...
class SiloRolePolicy(BaseModel):
    ...
    """ # noqa: E501
    role_assignments: List[SiloRoleRoleAssignment] = Field(description="Roles directly assigned on this resource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "role_assignments": [SiloRoleRoleAssignment.from_dict(_item) for _item in obj["role_assignments"]] if obj.get("role_assignments") is not None else None
        })
        return _obj
