...
class Histogramuint8(BaseModel):
    ...
    """ # noqa: E501
    bins: List[Binuint8] = Field(description="The bins of the histogram.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bins": [Binuint8.from_dict(_item) for _item in obj["bins"]] if obj.get("bins") is not None else None,
            "max": obj.get("max"),
            "min": obj.get("min"),
