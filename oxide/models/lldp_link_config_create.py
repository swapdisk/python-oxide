...
class LldpLinkConfigCreate(BaseModel):
    ...
    enabled: StrictBool = Field(description="Whether or not LLDP is enabled.")
    ...
    management_ip: Optional[StrictStr] = Field(default=None, description="The LLDP management IP TLV.")
    ...
    __properties: ClassVar[List[str]] = ["chassis_id", "enabled", "link_description", "link_name", "management_ip", "system_description", "system_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "management_ip": obj.get("management_ip"),
