...
class SwitchPortConfigCreate(BaseModel):
    ...
    """ # noqa: E501
    geometry: SwitchPortGeometry = Field(description="Link geometry for the switch port.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geometry": SwitchPortGeometry.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None
        })
        return _obj
