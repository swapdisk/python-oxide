...
class Histogramfloat(BaseModel):
    ...
    """ # noqa: E501
    bins: List[Binfloat] = Field(description="The bins of the histogram.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bins": [Binfloat.from_dict(_item) for _item in obj["bins"]] if obj.get("bins") is not None else None,
            "max": obj.get("max"),
            "min": obj.get("min"),
