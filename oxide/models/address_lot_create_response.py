...
class AddressLotCreateResponse(BaseModel):
    ...
    """ # noqa: E501
    blocks: List[AddressLotBlock] = Field(description="The address lot blocks that were created.")
    lot: AddressLot = Field(description="The address lot that was created.")
    __properties: ClassVar[List[str]] = ["blocks", "lot"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.blocks:
            ...
            _dict['blocks'] = _items
        # override the default output from pydantic by calling `to_dict()` of lot
        if self.lot:
            _dict['lot'] = self.lot.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocks": [AddressLotBlock.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None,
            "lot": AddressLot.from_dict(obj["lot"]) if obj.get("lot") is not None else None
        })
        return _obj
