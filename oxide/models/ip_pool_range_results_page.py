...
class IpPoolRangeResultsPage(BaseModel):
    ...
    """ # noqa: E501
    items: List[IpPoolRange] = Field(description="list of items on this page of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [IpPoolRange.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
