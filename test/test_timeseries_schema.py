...
class TestTimeseriesSchema(unittest.TestCase):
    """TimeseriesSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeseriesSchema:
        """Test TimeseriesSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeseriesSchema`
        """
        model = TimeseriesSchema()
        if include_optional:
